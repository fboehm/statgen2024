...
\title{Assessing Evidence for a Causal Effect of Fibromuscular Dysplasia on Chronic Kidney Disease: A Two-Sample Mendelian Randomization Study}
...
\textbf{Fibromuscular dysplasia (FMD)} is a systemic disease of artery walls that decreases target organ perfusion. Case studies have identified \textbf{chronic kidney disease (CKD)} as a possible consequence.   
\begin{itemize}
\item The first item.
